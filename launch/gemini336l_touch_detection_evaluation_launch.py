...
def generate_launch_description():
    ...
    camera1_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'color_fps': EnvironmentVariable('COLOR_FPS', default_value='15'),
            ...
            'depth_fps': EnvironmentVariable('DEPTH_FPS', default_value='15'),
            'depth_registration': 'True',
            'enable_decimation_filter': EnvironmentVariable('ENABLE_DECIMATION_FILTER', default_value='True'),
            'enable_spatial_filter': EnvironmentVariable('ENABLE_SPATIAL_FILTER', default_value='True'),
            'enable_temporal_filter': EnvironmentVariable('ENABLE_TEMPORAL_FILTER', default_value='True'),
            ...
            'color_exposure': EnvironmentVariable('COLOR_EXPOSURE', default_value='90'),
            'color_gain': EnvironmentVariable('COLOR_GAIN', default_value='1.0'),
            'enable_color_auto_white_balance': EnvironmentVariable('ENABLE_COLOR_AUTO_WHITE_BALANCE', default_value='False'),
            'color_white_balance': EnvironmentVariable('COLOR_WHITE_BALANCE', default_value='-1'),
            'color_brightness': EnvironmentVariable('COLOR_BRIGHTNESS', default_value='-60'),
    ...
    camera2_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'color_width': EnvironmentVariable('COLOR_WIDTH', default_value='640'),
            'color_height': EnvironmentVariable('COLOR_HEIGHT', default_value='480'),
            'color_fps': EnvironmentVariable('COLOR_FPS', default_value='10'),
            'depth_width': EnvironmentVariable('DEPTH_WIDTH', default_value='640'),
            'depth_height': EnvironmentVariable('DEPTH_HEIGHT', default_value='400'),
